...
The goal of Milestone 4 is to build out a test suite against `schema.execute()`. This is the raw, direct usage of the compiled `GraphQLSchema` object, without being used in any particular server or framework.
